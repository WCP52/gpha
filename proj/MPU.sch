...
U 1 1 54F6FB24
P 7500 6900
F 0 "#PWR0227" H 7500 6900 30  0001 C CNN
...
U 1 1 54F7163B
P 5200 1950
F 0 "#PWR0228" H 5200 1950 30  0001 C CNN
...
U 1 1 54F718F9
P 3450 1950
F 0 "#PWR0229" H 3450 1950 30  0001 C CNN
...
U 1 1 54F71917
P 3850 1950
F 0 "#PWR0230" H 3850 1950 30  0001 C CNN
...
U 1 1 54F7192E
P 4300 1950
F 0 "#PWR0231" H 4300 1950 30  0001 C CNN
...
U 1 1 54F71945
P 4700 1950
F 0 "#PWR0232" H 4700 1950 30  0001 C CNN
...
U 1 1 54F71A9E
P 4700 1450
F 0 "#PWR0233" H 4700 1450 30  0001 C CNN
...
U 1 1 54F72168
P 3050 1950
F 0 "#PWR0234" H 3050 1950 30  0001 C CNN
...
U 1 1 54F722F5
P 3450 2450
F 0 "#PWR0235" H 3450 2450 30  0001 C CNN
...
U 1 1 54F722FB
P 3850 2450
F 0 "#PWR0236" H 3850 2450 30  0001 C CNN
...
U 1 1 54F72301
P 4250 2450
F 0 "#PWR0237" H 4250 2450 30  0001 C CNN
...
U 1 1 54F72312
P 3050 2450
F 0 "#PWR0238" H 3050 2450 30  0001 C CNN
...
U 1 1 54F73FD5
P 4800 3750
F 0 "#PWR0239" H 4800 3750 30  0001 C CNN
...
U 1 1 54F7652D
P 9550 5850
F 0 "#PWR0240" H 9550 5850 30  0001 C CNN
...
U 1 1 54F7D5CC
P 11900 3500
F 0 "#PWR0241" H 11900 3500 30  0001 C CNN
...
U 1 1 54F7F580
P 11000 2400
F 0 "#PWR0242" H 11000 2450 30  0001 C CNN
...
U 1 1 54F7FA68
P 4700 1150
F 0 "#PWR0243" H 4700 1200 30  0001 C CNN
...
U 1 1 54F7FAA1
P 6100 1450
F 0 "#PWR0244" H 6100 1500 30  0001 C CNN
...
U 1 1 54F7FEDA
P 4300 3350
F 0 "#PWR0245" H 4300 3400 30  0001 C CNN
...
U 1 1 54F806BD
P 3050 2150
F 0 "#PWR0246" H 3050 2200 30  0001 C CNN
...
U 1 1 54F806EC
P 3450 2150
F 0 "#PWR0247" H 3450 2200 30  0001 C CNN
...
U 1 1 54F8071B
P 3850 2150
F 0 "#PWR0248" H 3850 2200 30  0001 C CNN
...
U 1 1 54F8074A
P 4250 2150
F 0 "#PWR0249" H 4250 2200 30  0001 C CNN
...
U 1 1 54F82AC0
P 8500 2250
F 0 "#PWR0250" H 8500 2300 30  0001 C CNN
...
U 1 1 54F831D3
P 8900 2250
F 0 "#PWR0251" H 8900 2300 30  0001 C CNN
...
U 1 1 54F83DA7
P 9000 3450
F 0 "#PWR0252" H 9000 3450 30  0001 C CNN
...
U 1 1 54F83E68
P 11000 3000
F 0 "#PWR0253" H 11000 3000 30  0001 C CNN
...
U 1 1 54F86D9A
P 9200 2250
F 0 "#PWR0254" H 9200 2300 30  0001 C CNN
...
F 6 "DIST DIGIKEY MZ1608-102YCT-ND" H 4600 3400 60  0001 C CNN "BOM"
	...
	1    0    0    -1  
$EndComp
Text HLabel 6000 4300 0    50   Output ~ 0
SYNTH_#CS
Wire Wire Line
	6000 4300 6200 4300
...
Wire Wire Line
	6200 3900 6000 3900
Text HLabel 6000 5100 0    50   Output ~ 0
SYNTH_SCK
Wire Wire Line
	6000 5100 6200 5100
...
Wire Wire Line
	6000 4900 6200 4900
Text HLabel 6000 5000 0    50   Output ~ 0
SYNTH_MOSI
Wire Wire Line
	6000 5000 6200 5000
Text HLabel 6000 5700 0    50   Input ~ 0
ADIN
Wire Wire Line
	6000 5700 6200 5700
